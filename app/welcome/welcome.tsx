...
const resources = [
  ...
  {
    href: "/red",
    text: <span className="text-red-500 hover:underline">R E D</span>,
    ...
    icon: (
      <svg
        ...
        stroke-linecap="round"
        stroke-linejoin="round"
        className="icon icon-tabler icons-tabler-outline icon-tabler-world-star stroke-red-500 fill-white dark:stroke-red-500 dark:fill-black"
      >
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
